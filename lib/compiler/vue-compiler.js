...
module.exports=function (file, content, config) {
    ...
    if (script) {
        ...
        const jsResult = jsCompiler.call(self, file, js, config);
    ...
    if (template) {
        ...
        const jsxResult=templateCompiler.call(self, file, jsx, config);
    ...
    if (styles && styles.length>0) {
        styles.map(function (style) {
            ...
            const styleResult=styleCompiler.call(self, file, styleCode, config);
